...
!(function (A, e) {
      ...
      next: function () {
        ...
        for (
          ...
          (A = (function (A, e, t, B, r) {
            ...
            if (
              (J === i && -1 !== [J, Y, N, P].indexOf(r)) ||
              (-1 !== [Y, N].indexOf(i) && -1 !== [Y, W].indexOf(r)) ||
              (-1 !== [W, P].indexOf(i) && r === W)
            )
              return q;
            if (
        ...
        return (
          ZA(A).forEach(function (A, e) {
            var t,
              A = A[0];
            if (0 === e) {
              if (PA(A) && "linear" === A.value) return void (n = 1);
              if (PA(A) && "radial" === A.value) return void (n = 2);
            }
            18 === A.type &&
              ("from" === A.name
  ...
  ((we = Ne = Ne || {}).NORMAL = "normal"), (we.BREAK_ALL = "break-all");
  function Gt(A, e) {
    return 0 != (A & e);
  }
  function Ot(A, e, t) {
  ...
  var Vt = {
    ...
    kt = {
      ...
      parse: function (A, e) {
        ...
        if (NA(e)) return { auto: !1, order: e.number };
    ...
    Wt = {
      ...
      prefix: !1,
      parse: function (A, e) {
        return NA(e) ? e.number : !PA(e) || "bold" !== e.value ? 400 : 700;
      },
    },
    Zt = {
      name: "font-variant",
    ...
    tB = {
      ...
      parse: function (A, e) {
        var t = [];
        return (
          e.filter(PA).forEach(function (A) {
            switch (A.value) {
              case "stroke":
                t.push(1);
                break;
  ...
  function sB(A, e) {
    (this.animationDuration = QB(A, $t, e.animationDuration)),
      ...
      (this.backgroundSize = QB(A, Pe, e.backgroundSize)),
      ...
      (this.listStyleImage = QB(A, lt, e.listStyleImage)),
      (this.listStylePosition = QB(A, Ct, e.listStylePosition)),
      ...
      (this.opacity = QB(A, Nt, e.opacity));
      ...
      QB = function (A, e, t) {
        ...
        switch (e.type) {
          case 2:
            ...
            return e.parse(A, PA(n) ? n.value : e.initialValue);
          case 0:
  ...
  function HB(A) {
    ...
    return {
      next: function () {
        ...
        for (
          ...
          (A = (function (A, e) {
            var t = e - 2,
              ...
              r = A[e - 1],
              e = A[e];
            if (2 === r && 3 === e) return SB;
            if (2 === r || 3 === r || 4 === r) return "÷";
            if (2 === e || 3 === e || 4 === e) return "÷";
            if (r === bB && -1 !== [bB, DB, vB, xB].indexOf(e)) return SB;
            if (!((r !== vB && r !== DB) || (e !== DB && 10 !== e))) return SB;
            if ((r === xB || 10 === r) && 10 === e) return SB;
            if (13 === e || 5 === e) return SB;
            if (7 === e) return SB;
            if (1 === r) return SB;
            if (13 === r && 14 === e) {
              for (; 5 === B; ) B = A[--t];
        ...
        if (A === SB && r !== B) return { done: !0, value: null };
        var e = function () {
  ...
  var EB,
    ...
    MB =
      ...
      (IB =
        2 === KB[5]
          ? lB(mB, (24 + KB[4]) / 2)
          : ((yB = KB),
            (mB = Math.ceil((24 + KB[4]) / 4)),
            yB.slice
              ? yB.slice(mB, IB)
              : new Uint32Array(Array.prototype.slice.call(yB, mB, IB)))),
      new CB(KB[0], KB[1], KB[2], KB[3], EB, IB)),
    SB = "×",
    TB = function (A, e, t, B, r) {
    ...
    OB = {
      get SUPPORT_RANGE_BOUNDS() {
        ...
        return (
          Object.defineProperty(OB, "SUPPORT_RANGE_BOUNDS", { value: A }), A
        );
      },
      get SUPPORT_WORD_BREAKING() {
        var A =
          OB.SUPPORT_RANGE_BOUNDS &&
          (function (A) {
        ...
        return (
          Object.defineProperty(OB, "SUPPORT_WORD_BREAKING", { value: A }), A
        );
      },
      get SUPPORT_SVG_DRAWING() {
        ...
        return (
          Object.defineProperty(OB, "SUPPORT_SVG_DRAWING", { value: A }), A
        );
      },
                  ...
                  GB(e)
                    .then(function (A) {
                      ...
                      return (
                        ...
                        pB(e) ? GB(TB(B, B, 0, 0, A)) : Promise.reject(!1)
                      );
                    })
                    .then(function (A) {
                      return (
                        r.drawImage(A, 0, 0),
                        pB(r.getImageData(0, 0, B, B).data)
                      );
                    })
                    .catch(function () {
                      return !1;
      ...
      get SUPPORT_CORS_IMAGES() {
        ...
        return (
          Object.defineProperty(OB, "SUPPORT_CORS_IMAGES", { value: A }), A
        );
      },
      get SUPPORT_RESPONSE_TYPE() {
        var A = "string" == typeof new XMLHttpRequest().responseType;
        return (
          Object.defineProperty(OB, "SUPPORT_RESPONSE_TYPE", { value: A }), A
        );
      },
      get SUPPORT_CORS_XHR() {
        var A = "withCredentials" in new XMLHttpRequest();
        return Object.defineProperty(OB, "SUPPORT_CORS_XHR", { value: A }), A;
      },
      get SUPPORT_NATIVE_TEXT_SEGMENTATION() {
        var A = !("undefined" == typeof Intl || !Intl.Segmenter);
        return (
          Object.defineProperty(OB, "SUPPORT_NATIVE_TEXT_SEGMENTATION", {
            value: A,
          }),
          A
        );
    ...
    NB = function (A) {
      if (OB.SUPPORT_NATIVE_TEXT_SEGMENTATION) {
    ...
    XB = [32, 160, 4961, 65792, 65793, 4153, 4241],
    JB = function (A, e) {
      for (
        var t,
          B = oA(A, {
    ...
    YB = function (A, e, t) {
      var r, n, s, o, i;
      (this.text = WB(e.data, t.textTransform)),
        (this.textBounds =
          ((r = A),
          (A = this.text),
          (s = e),
          ...
          A.forEach(function (A) {
            ...
            n.textDecorationLine.length || 0 < A.trim().length
              ? OB.SUPPORT_RANGE_BOUNDS
                ? 1 < (B = RB(s, i, A.length).getClientRects()).length
                  ? ((e = NB(A)),
                    (t = 0),
                    e.forEach(function (A) {
                      o.push(
                        new VB(
                          ...
                          d.fromDOMRectList(
                            r,
                            RB(s, t + i, A.length).getClientRects()
                          )
                        )
                      ),
                        (t += A.length);
                    }))
                  : o.push(new VB(A, d.fromDOMRectList(r, B)))
                : ((B = s.splitText(A.length)),
                  o.push(new VB(A, kB(r, s))),
                  (s = B))
              : OB.SUPPORT_RANGE_BOUNDS || (s = s.splitText(A.length)),
              (i += A.length);
          }),
          o));
    },
  ...
  var rr,
    nr = (A(sr, (rr = aB)), sr);
  function sr(A, e) {
    A = rr.call(this, A, e) || this;
    return (A.value = e.value), A;
  }
  var or,
    ir = (A(Qr, (or = aB)), Qr);
  function Qr(A, e) {
    A = or.call(this, A, e) || this;
    return (
      (A.start = e.start),
  ...
  var cr,
    ar = [{ type: 15, flags: 0, unit: "px", number: 3 }],
    gr = [{ type: 16, flags: 0, number: 50 }],
    wr = "checkbox",
    Ur = "radio",
    lr = "password",
    Cr = 707406591,
  ...
  var hr,
    dr = (A(fr, (hr = aB)), fr);
  function fr(A, e) {
    (A = hr.call(this, A, e) || this), (e = e.options[e.selectedIndex || 0]);
  ...
  function Kr(A, e) {
    ...
    try {
      e.contentWindow &&
        ...
        ((r.tree = Mr(A, e.contentWindow.document.documentElement)),
  ...
  var Dr = ["OL", "UL", "MENU"],
    vr = function (e, A, t, B) {
      for (var r = A.firstChild; r; r = s) {
        var n,
          s = r.nextSibling;
        Gr(r) && 0 < r.data.trim().length
          ? t.textNodes.push(new YB(e, r, t.styles))
          : Or(r) &&
            (jr(r) && r.assignedNodes
              ? r.assignedNodes().forEach(function (A) {
                  return vr(e, A, t, B);
                })
              : (n = xr(e, r)).styles.isVisible() &&
                (Sr(r, n, B) ? (n.flags |= 4) : Tr(n.styles) && (n.flags |= 2),
                -1 !== Dr.indexOf(r.tagName) && (n.flags |= 8),
                t.elements.push(n),
                r.slot,
                r.shadowRoot
                  ? vr(e, r.shadowRoot, n, B)
                  : _r(r) || Xr(r) || qr(r) || vr(e, r, n, B)));
      }
    },
    xr = function (A, e) {
      return new (
    ...
    Vr = function (A) {
      return Or(A) && void 0 !== A.style && !kr(A);
    },
    kr = function (A) {
    ...
    zr =
      (($r.prototype.getCounterValue = function (A) {
        A = this.counters[A];
  ...
  function tn(A, e, t, B, r) {
    var n = t - e + 1;
    return (
      (A < 0 ? "-" : "") +
      (en(Math.abs(A), n, B, function (A) {
  ...
  function Bn(A, e, t) {
    ...
    var B = e.length;
    return (
      en(Math.abs(A), B, !1, function (A) {
        return e[Math.floor(A % B)];
      }) + t
    );
  }
  function rn(A, e, t, B, r, n) {
    if (A < -9999 || 9999 < A) return gn(A, 4, 0 < r.length);
    var s = Math.abs(A),
      o = r;
    if (0 === s) return e[0] + o;
    ...
    gn = function (A, e, t) {
      ...
      switch (e) {
        ...
        case 2:
          return "◾" + s;
        case 5:
          var o = tn(A, 48, 57, !0, B);
          return o.length < 4 ? "0" + o : o;
        case 4:
          return Bn(A, "〇一二三四五六七八九", r);
        case 6:
          return An(A, 1, 3999, sn, 3, B).toLowerCase();
        case 7:
          return An(A, 1, 3999, sn, 3, B);
        case 8:
          return tn(A, 945, 969, !1, B);
        case 9:
          return tn(A, 97, 122, !1, B);
        case 10:
          return tn(A, 65, 90, !1, B);
        case 11:
          return tn(A, 1632, 1641, !0, B);
        case 12:
        case 49:
          return An(A, 1, 9999, on, 3, B);
        case 35:
          return An(A, 1, 9999, on, 3, B).toLowerCase();
        case 13:
          return tn(A, 2534, 2543, !0, B);
        case 14:
        case 30:
          return tn(A, 6112, 6121, !0, B);
        case 15:
          return Bn(A, "子丑寅卯辰巳午未申酉戌亥", r);
        case 16:
          return Bn(A, "甲乙丙丁戊己庚辛壬癸", r);
        case 17:
        case 48:
          return rn(A, "零一二三四五六七八九", "十百千萬", "負", r, 14);
        case 47:
          return rn(A, "零壹貳參肆伍陸柒捌玖", "拾佰仟萬", "負", r, 15);
        case 42:
          return rn(A, "零一二三四五六七八九", "十百千萬", "负", r, 14);
        case 41:
          return rn(A, "零壹贰叁肆伍陆柒捌玖", "拾佰仟萬", "负", r, 15);
        case 26:
          return rn(A, "〇一二三四五六七八九", "十百千万", "マイナス", r, 0);
        case 25:
          return rn(A, "零壱弐参四伍六七八九", "拾百千万", "マイナス", r, 7);
        case 31:
          return rn(A, "영일이삼사오육칠팔구", "십백천만", an, n, 7);
        case 33:
          return rn(A, "零一二三四五六七八九", "十百千萬", an, n, 0);
        case 32:
          return rn(A, "零壹貳參四五六七八九", "拾百千", an, n, 7);
        case 18:
          return tn(A, 2406, 2415, !0, B);
        case 20:
          return An(A, 1, 19999, cn, 3, B);
        case 21:
          return tn(A, 2790, 2799, !0, B);
        case 22:
          return tn(A, 2662, 2671, !0, B);
        case 22:
          return An(A, 1, 10999, Qn, 3, B);
        case 23:
          return Bn(
            A,
        ...
        case 34:
          return tn(A, 3792, 3801, !0, B);
        case 37:
          return tn(A, 6160, 6169, !0, B);
        case 38:
          return tn(A, 4160, 4169, !0, B);
        case 39:
          return tn(A, 2918, 2927, !0, B);
        case 40:
          return tn(A, 1776, 1785, !0, B);
        case 43:
          return tn(A, 3046, 3055, !0, B);
        case 44:
          return tn(A, 3174, 3183, !0, B);
        case 45:
          return tn(A, 3664, 3673, !0, B);
        case 46:
          return tn(A, 3872, 3881, !0, B);
        default:
          return tn(A, 48, 57, !0, B);
      }
    },
    wn = "data-html2canvas-ignore",
    Un =
      ((ln.prototype.toIFrame = function (A, B) {
        var e = this,
          r = un(A, B);
        if (!r.contentWindow)
            ...
            return a(e, void 0, void 0, function () {
              ...
              return H(this, function (A) {
                switch (A.label) {
                  case 0:
                    return (
                      this.scrolledElements.forEach(En),
                      s &&
        ...
        return (
          o.open(),
          o.write(Hn(document.doctype) + "<html></html>"),
          pn(this.referenceElement.ownerDocument, t, n),
          o.replaceChild(o.adoptNode(this.documentElement), o.documentElement),
          o.close(),
          A
        );
      }),
      (ln.prototype.createElementClone = function (A) {
        if ((cB(A, 2), Yr(A))) return this.createCanvasClone(A);
        if (mr(A)) return this.createVideoClone(A);
        ...
        return (
          ...
          br(e) ? this.createCustomElementClone(e) : e
        );
      }),
      (ln.prototype.createCustomElementClone = function (A) {
        var e = document.createElement("html2canvascustomelement");
        return fn(A.style, e), e;
      }),
      (ln.prototype.createStyleClone = function (A) {
        try {
          var e = A.sheet;
          if (e && e.cssRules) {
      ...
      (ln.prototype.createCanvasClone = function (e) {
        var A;
      ...
      (ln.prototype.createVideoClone = function (e) {
      ...
      (ln.prototype.appendChildNode = function (A, e, t) {
        (Or(e) &&
          ("SCRIPT" === e.tagName ||
            e.hasAttribute(wn) ||
            ("function" == typeof this.options.ignoreElements &&
              this.options.ignoreElements(e)))) ||
          (this.options.copyStyles && Or(e) && Lr(e)) ||
          A.appendChild(this.cloneNode(e, t));
      }),
      (ln.prototype.cloneChildNodes = function (A, e, t) {
        for (
          var B, r = this, n = (A.shadowRoot || A).firstChild;
          n;
          n = n.nextSibling
        )
          Or(n) && jr(n) && "function" == typeof n.assignedNodes
            ? (B = n.assignedNodes()).length &&
              B.forEach(function (A) {
                return r.appendChildNode(e, A, t);
              })
            : this.appendChildNode(e, n, t);
      }),
      (ln.prototype.cloneNode = function (A, e) {
        if (Gr(A)) return document.createTextNode(A.data);
        ...
        if (t && Or(A) && (Vr(A) || kr(A))) {
          ...
          this.referenceElement === A &&
            ...
            Jr(B) && mn(B);
          (t = this.counters.parse(new iB(this.context, r))),
            (n = this.resolvePseudoContent(A, B, n, nn.BEFORE));
          br(A) && (e = !0),
            mr(A) || this.cloneChildNodes(A, B, e),
            n && B.insertBefore(n, B.firstChild);
          s = this.resolvePseudoContent(A, B, s, nn.AFTER);
          return (
            s && B.appendChild(s),
            this.counters.pop(t),
            ((r && (this.options.copyStyles || kr(A)) && !Zr(A)) || e) &&
              fn(r, B),
            (0 === A.scrollTop && 0 === A.scrollLeft) ||
              this.scrolledElements.push([B, A.scrollLeft, A.scrollTop]),
            (_r(A) || qr(A)) && (_r(B) || qr(B)) && (B.value = A.value),
            B
          );
        }
        return A.cloneNode(!1);
      }),
      (ln.prototype.resolvePseudoContent = function (o, A, e, t) {
        var i = this;
        if (e) {
          var B = e.content,
            Q = A.ownerDocument;
          if (
            ...
            fn(e, a),
                  ...
                  "attr" === A.name
                    ...
                    ? ((r = (B = A.values.filter(WA))[0]),
                      ...
                      r &&
                        ...
                        (s = B && PA(B) ? ut.parse(i.context, B.value) : 3),
                        a.appendChild(Q.createTextNode(gn(t, s, !1)))))
                    : "counters" === A.name &&
                      ...
                      r &&
                        ...
                        (n = B && PA(B) ? ut.parse(i.context, B.value) : 3),
              ...
              (a.className = In + " " + yn);
            t = t === nn.BEFORE ? " " + In : " " + yn;
            return kr(A) ? (A.className.baseValue += t) : (A.className += t), a;
          }
        }
      }),
      (ln.destroy = function (A) {
  ...
  var un = function (A, e) {
    ...
    fn = function (A, e) {
      for (var t = A.length - 1; 0 <= t; t--) {
        var B = A.item(t);
        -1 === dn.indexOf(B) && e.style.setProperty(B, A.getPropertyValue(B));
      }
      return e;
    },
    Hn = function (A) {
    ...
    In = "___html2canvas___pseudoelement_before",
    ...
    bn =
      ((Dn.getOrigin = function (A) {
        var e = Dn._link;
        return e
          ? ((e.href = A), (e.href = e.href), e.protocol + e.hostname + e.port)
          : "about:blank";
      }),
      (Dn.isSameOrigin = function (A) {
        return Dn.getOrigin(A) === Dn._origin;
      }),
      (Dn.setContext = function (A) {
        (Dn._link = A.document.createElement("a")),
          (Dn._origin = Dn.getOrigin(A.location.href));
      }),
      (Dn._origin = "about:blank"),
      Dn);
  function Dn() {}
  var vn =
    ((xn.prototype.addImage = function (A) {
    ...
    (xn.prototype.match = function (A) {
      return this._cache[A];
    }),
    (xn.prototype.loadImage = function (s) {
      return a(this, void 0, void 0, function () {
        ...
        return H(this, function (A) {
          switch (A.label) {
            case 0:
              return ((e = bn.isSameOrigin(s)),
              (B =
                !On(s) &&
                !0 === this._options.useCORS &&
                OB.SUPPORT_CORS_IMAGES &&
                !e),
              (t =
                !On(s) &&
                !e &&
                ...
                OB.SUPPORT_CORS_XHR &&
                !B),
              e || !1 !== this._options.allowTaint || On(s) || kn(s) || t || B)
                ...
                [
                  ...
                  new Promise(function (A, e) {
                    ...
                    (t.onload = function () {
                      ...
                      (t.onerror = e),
                      (Vn(r) || B) && (t.crossOrigin = "anonymous"),
                      (t.src = r),
                      !0 === t.complete &&
                        setTimeout(function () {
                          return A(t);
  ...
  var Mn = /^data:image\/svg\+xml/i,
    Sn = /^data:image\/.*;base64,/i,
    Tn = /^data:image\/.*/i,
    Gn = function (A) {
      return OB.SUPPORT_SVG_DRAWING || !Rn(A);
    },
    On = function (A) {
      return Tn.test(A);
    },
    ...
    Rn = function (A) {
      return "svg" === A.substr(-3).toLowerCase() || Mn.test(A);
    },
    Nn =
  ...
  function Xn(A, e, t) {
    return new Nn(A.x + (e.x - A.x) * t, A.y + (e.y - A.y) * t);
  }
  var Jn =
    ((Yn.prototype.subdivide = function (A, e) {
      var t = Xn(this.start, this.startControl, A),
        B = Xn(this.startControl, this.endControl, A),
        r = Xn(this.endControl, this.end, A),
        n = Xn(t, B, A),
        B = Xn(B, r, A),
        A = Xn(n, B, A);
      return e ? new Yn(this.start, t, n, A) : new Yn(A, B, r, this.end);
    }),
    (Yn.prototype.add = function (A, e) {
      return new Yn(
        this.start.add(A, e),
    ...
    (Yn.prototype.reverse = function () {
      return new Yn(this.end, this.endControl, this.startControl, this.start);
    }),
    Yn);
  function Yn(A, e, t, B) {
    (this.type = 1),
  ...
  var Zn,
    _n = function (A) {
      var e = A.styles,
        t = A.bounds,
        B = (C = zA(e.borderTopLeftRadius, t.width, t.height))[0],
        r = C[1],
      ...
      (this.topLeftBorderDoubleOuterBox =
        0 < B || 0 < r
          ? As(t.left + F / 3, t.top + l / 3, B - F / 3, r - l / 3, Zn.TOP_LEFT)
          : new Nn(t.left + F / 3, t.top + l / 3)),
        (this.topRightBorderDoubleOuterBox =
          0 < B || 0 < r
            ? As(t.left + a, t.top + l / 3, n - C / 3, s - l / 3, Zn.TOP_RIGHT)
            : new Nn(t.left + t.width - C / 3, t.top + l / 3)),
        (this.bottomRightBorderDoubleOuterBox =
          0 < o || 0 < i
            ? As(t.left + w, t.top + g, o - C / 3, i - u / 3, Zn.BOTTOM_RIGHT)
            : new Nn(t.left + t.width - C / 3, t.top + t.height - u / 3)),
        (this.bottomLeftBorderDoubleOuterBox =
          0 < Q || 0 < c
            ...
            : new Nn(t.left + F / 3, t.top + t.height - u / 3)),
        (this.topLeftBorderDoubleInnerBox =
          0 < B || 0 < r
            ...
            : new Nn(t.left + (2 * F) / 3, t.top + (2 * l) / 3)),
        (this.topRightBorderDoubleInnerBox =
          0 < B || 0 < r
            ...
            : new Nn(t.left + t.width - (2 * C) / 3, t.top + (2 * l) / 3)),
        ...
        (this.bottomLeftBorderDoubleInnerBox =
          0 < Q || 0 < c
            ...
            : new Nn(t.left + (2 * F) / 3, t.top + t.height - (2 * u) / 3)),
        (this.topLeftBorderStroke =
          0 < B || 0 < r
            ...
            : new Nn(t.left + F / 2, t.top + l / 2)),
        (this.topRightBorderStroke =
          0 < B || 0 < r
            ? As(t.left + a, t.top + l / 2, n - C / 2, s - l / 2, Zn.TOP_RIGHT)
            : new Nn(t.left + t.width - C / 2, t.top + l / 2)),
        (this.bottomRightBorderStroke =
          0 < o || 0 < i
            ? As(t.left + w, t.top + g, o - C / 2, i - u / 2, Zn.BOTTOM_RIGHT)
            : new Nn(t.left + t.width - C / 2, t.top + t.height - u / 2)),
        (this.bottomLeftBorderStroke =
          0 < Q || 0 < c
            ...
            : new Nn(t.left + F / 2, t.top + t.height - u / 2)),
        (this.topLeftBorderBox =
          0 < B || 0 < r
            ? As(t.left, t.top, B, r, Zn.TOP_LEFT)
            : new Nn(t.left, t.top)),
        (this.topRightBorderBox =
          0 < n || 0 < s
            ? As(t.left + a, t.top, n, s, Zn.TOP_RIGHT)
            : new Nn(t.left + t.width, t.top)),
        (this.bottomRightBorderBox =
          0 < o || 0 < i
            ? As(t.left + w, t.top + g, o, i, Zn.BOTTOM_RIGHT)
            : new Nn(t.left + t.width, t.top + t.height)),
        (this.bottomLeftBorderBox =
          0 < Q || 0 < c
            ? As(t.left, t.top + U, Q, c, Zn.BOTTOM_LEFT)
            : new Nn(t.left, t.top + t.height)),
        ...
        (this.topRightPaddingBox =
          0 < n || 0 < s
            ...
            : new Nn(t.left + t.width - C, t.top + l)),
        (this.bottomRightPaddingBox =
          0 < o || 0 < i
            ...
            : new Nn(t.left + t.width - C, t.top + t.height - u)),
        (this.bottomLeftPaddingBox =
          0 < Q || 0 < c
            ...
            : new Nn(t.left + F, t.top + t.height - u)),
        ...
        (this.topRightContentBox =
          0 < n || 0 < s
            ...
            : new Nn(t.left + t.width - (C + d), t.top + l + h)),
        (this.bottomRightContentBox =
          0 < o || 0 < i
            ...
            : new Nn(t.left + t.width - (C + d), t.top + t.height - (u + f))),
        (this.bottomLeftContentBox =
          0 < Q || 0 < c
            ...
            : new Nn(t.left + F + A, t.top + t.height - (u + f)));
    };
  ((we = Zn = Zn || {})[(we.TOP_LEFT = 0)] = "TOP_LEFT"),
  ...
  var As = function (A, e, t, B, r) {
    ...
    ns =
      ((ss.prototype.getEffects = function (e) {
        for (
  ...
  function ss(A, e) {
    ...
    (this.container = A),
      (this.parent = e),
      (this.effects = []),
      (this.curves = new _n(this.container)),
      this.container.styles.opacity < 1 &&
        this.effects.push(new Bs(this.container.styles.opacity)),
      null !== this.container.styles.transform &&
        ...
        this.effects.push(new es(e, t, B))),
      0 !== this.container.styles.overflowX &&
        ((t = qn(this.curves)),
        (B = jn(this.curves)),
        $n(t, B)
          ? this.effects.push(new ts(t, 6))
          : (this.effects.push(new ts(t, 2)), this.effects.push(new ts(B, 4))));
  }
  function os(A, e) {
    switch (e) {
      case 0:
  ...
  function cs(A, e, t) {
    var B =
        ((r = Fs(A.styles.backgroundOrigin, e)),
        (n = A),
        0 === r ? n.bounds : (2 === r ? Qs : is)(n)),
      r =
        ((s = Fs(A.styles.backgroundClip, e)),
        (o = A),
        0 === s ? o.bounds : (2 === s ? Qs : is)(o)),
      n = us(Fs(A.styles.backgroundSize, e), t, B),
      s = n[0],
      o = n[1],
      t = zA(Fs(A.styles.backgroundPosition, e), B.width - s, B.height - o);
    return [
      hs(Fs(A.styles.backgroundRepeat, e), t, n, B, r),
  ...
  function as(A) {
    return PA(A) && A.value === xe.AUTO;
  }
  function gs(A) {
    return "number" == typeof A;
  }
  var ws = function (Q, c, a, g) {
    ...
    Us = function (A, e) {
      for (
        var t = A instanceof ir ? A.start : 1,
          B = A instanceof ir && A.reversed,
          r = 0;
        r < e.length;
        r++
      ) {
        var n = e[r];
        n.container instanceof nr &&
          "number" == typeof n.container.value &&
          0 !== n.container.value &&
          (t = n.container.value),
          (n.listValue = gn(t, n.container.styles.listStyleType, !0)),
          (t += B ? -1 : 1);
      }
    },
    ls = function (A, e) {
      var t = [];
      return (
        Wn(A) ? t.push(A.subdivide(0.5, !1)) : t.push(A),
        Wn(e) ? t.push(e.subdivide(0.5, !0)) : t.push(e),
        t
      );
    },
    Cs = function (A, e, t, B) {
      var r = [];
      return (
        Wn(A) ? r.push(A.subdivide(0.5, !1)) : r.push(A),
        Wn(t) ? r.push(t.subdivide(0.5, !0)) : r.push(t),
        Wn(B) ? r.push(B.subdivide(0.5, !0).reverse()) : r.push(B),
        Wn(e) ? r.push(e.subdivide(0.5, !1).reverse()) : r.push(e),
        r
      );
    },
    us = function (A, e, t) {
      ...
      var i = gs(n);
      if (PA(s) && (s.value === xe.CONTAIN || s.value === xe.COVER))
        return gs(n)
    ...
    hs = function (A, e, t, B, r) {
      ...
      switch (A) {
        case 2:
          return [
            new Nn(Math.round(B.left), Math.round(B.top + s)),
            new Nn(Math.round(B.left + B.width), Math.round(B.top + s)),
            new Nn(Math.round(B.left + B.width), Math.round(i + B.top + s)),
            new Nn(Math.round(B.left), Math.round(i + B.top + s)),
          ];
        case 3:
          return [
            new Nn(Math.round(B.left + n), Math.round(B.top)),
            new Nn(Math.round(B.left + n + o), Math.round(B.top)),
            new Nn(Math.round(B.left + n + o), Math.round(B.height + B.top)),
            new Nn(Math.round(B.left + n), Math.round(B.height + B.top)),
          ];
        case 1:
          return [
            new Nn(Math.round(B.left + n), Math.round(B.top + s)),
            new Nn(Math.round(B.left + n + o), Math.round(B.top + s)),
            new Nn(Math.round(B.left + n + o), Math.round(B.top + s + i)),
            new Nn(Math.round(B.left + n), Math.round(B.top + s + i)),
          ];
        default:
          return [
            new Nn(Math.round(r.left), Math.round(r.top)),
            new Nn(Math.round(r.left + r.width), Math.round(r.top)),
            new Nn(Math.round(r.left + r.width), Math.round(r.height + r.top)),
            new Nn(Math.round(r.left), Math.round(r.height + r.top)),
          ];
      }
    },
    ds = "Hidden Text",
    fs =
      ((Hs.prototype.parseMetrics = function (A, e) {
        ...
        (t.style.visibility = "hidden"),
          ...
          (r.style.margin = "0"),
          (r.style.padding = "0"),
          r.appendChild(this._document.createTextNode(ds)),
          t.appendChild(r),
          t.appendChild(B);
        e = B.offsetTop - r.offsetTop + 2;
        t.removeChild(r),
          t.appendChild(this._document.createTextNode(ds)),
          (t.style.lineHeight = "normal"),
          (B.style.verticalAlign = "super");
        B = B.offsetTop - t.offsetTop + 2;
        return n.removeChild(t), { baseline: e, middle: B };
      }),
      (Hs.prototype.getMetrics = function (A, e) {
        var t = A + " " + e;
        return (
  ...
  var ps,
    ...
    Es =
      ...
      (Is.prototype.applyEffect = function (A) {
        this.ctx.save(),
          ...
          0 === A.type &&
            ...
            this.ctx.translate(-A.offsetX, -A.offsetY)),
          zn(A) && (this.path(A.path), this.ctx.clip()),
          this._activeEffects.push(A);
      }),
      (Is.prototype.popEffect = function () {
        this._activeEffects.pop(), this.ctx.restore();
      }),
      (Is.prototype.renderStack = function (e) {
        return a(this, void 0, void 0, function () {
          return H(this, function (A) {
            switch (A.label) {
              case 0:
      ...
      (Is.prototype.renderNode = function (e) {
        return a(this, void 0, void 0, function () {
          return H(this, function (A) {
            switch (A.label) {
              case 0:
      ...
      (Is.prototype.renderTextWithLetterSpacing = function (t, A, B) {
        var r = this;
        0 === A
          ? this.ctx.fillText(t.text, t.bounds.left, t.bounds.top + B)
          : NB(t.text).reduce(function (A, e) {
              return (
      ...
      (Is.prototype.renderReplacedElement = function (A, e, t) {
        var B;
        t &&
          0 < A.intrinsicWidth &&
          0 < A.intrinsicHeight &&
      ...
      (Is.prototype.renderNodeContent = function (w) {
        return a(this, void 0, void 0, function () {
              ...
              case 14:
                if (
                  ...
                  switch (
                    ...
                    (this.ctx.textBaseline = "alphabetic"),
                    (this.ctx.textAlign = Ls(e.styles.textAlign)),
                    (g = Qs(e)),
                    (o = 0),
                    e.styles.textAlign)
                  ) {
                  ...
                  (i = g.add(o, 0, 0, -g.height / 2 + 1)),
                    ...
                    this.path([
                      new Nn(g.left, g.top),
                      new Nn(g.left + g.width, g.top),
                      new Nn(g.left + g.width, g.top + g.height),
                      new Nn(g.left, g.top + g.height),
                    ]),
                    this.ctx.clip(),
      ...
      (Is.prototype.renderStackContent = function (C) {
        return a(this, void 0, void 0, function () {
          var e, t, B, r, n, s, o, i, Q, c, a, g, w, U, l;
          return H(this, function (A) {
            switch (A.label) {
              case 0:
                return (
                  Gt(C.element.container.flags, 16),
              ...
              case 6:
                A.sent(), (B = 0), (r = C.nonInlineLevel), (A.label = 7);
              case 7:
                return B < r.length
                  ? ((l = r[B]), [4, this.renderNode(l)])
                  : [3, 10];
              case 8:
                A.sent(), (A.label = 9);
              case 9:
      ...
      (Is.prototype.path = function (A) {
        this.ctx.beginPath(), this.formatPath(A), this.ctx.closePath();
      }),
      (Is.prototype.formatPath = function (A) {
        var B = this;
        A.forEach(function (A, e) {
          var t = Wn(A) ? A.start : A;
      ...
      (Is.prototype.renderRepeat = function (A, e, t, B) {
        this.path(A),
      ...
      (Is.prototype.resizeImage = function (A, e, t) {
      ...
      (Is.prototype.renderBackgroundImage = function (f) {
        return a(this, void 0, void 0, function () {
          var h, e, d, t, B, r;
          return H(this, function (A) {
            switch (A.label) {
              case 0:
                (h = f.styles.backgroundImage.length - 1),
                  (e = function (e) {
                    var t, B, r, n, s, o, i, Q, c, a, g, w, U, l, C, u, F;
                    return H(this, function (A) {
                      switch (A.label) {
                        case 0:
                        ...
                        case 5:
                          1 === e.type
                            ? ((F = cs(f, h, [null, null, null])),
                              ...
                              (F.height = a),
                              (C = F.getContext("2d")),
                              (n = C.createLinearGradient(r, u, i, Q)),
                              ue(e.stops, l).forEach(function (A) {
                            ...
                            : 2 === e.type &&
                              ...
                              (c = u[3]),
                              (a = u[4]),
                              (l = 0 === e.position.length ? [se] : e.position),
                              (g = ie(l[0], c)),
                              (w = ie(l[l.length - 1], a)),
                              (C = (function (A, e, t, B, r) {
                                var n,
                                  s,
                                  o,
                                  i,
      ...
      (Is.prototype.renderSolidBorder = function (e, t, B) {
        return a(this, void 0, void 0, function () {
          return H(this, function (A) {
            return (
              this.path(os(B, t)),
      ...
      (Is.prototype.renderDoubleBorder = function (t, B, r, n) {
        return a(this, void 0, void 0, function () {
          var e;
          return H(this, function (A) {
            switch (A.label) {
      ...
      (Is.prototype.renderNodeBackgroundAndBorders = function (c) {
        return a(this, void 0, void 0, function () {
          var e,
            t,
            B,
          ...
          return H(this, function (A) {
            switch (A.label) {
              case 0:
                ...
                (r = ms(Fs(e.backgroundClip, 0), c.curves)),
      ...
      (Is.prototype.renderDashedDottedBorder = function (g, w, U, l, C) {
        return a(this, void 0, void 0, function () {
          ...
          return H(this, function (A) {
            return (
              ...
              (Q = (function (A, e) {
                switch (e) {
                  case 0:
                    return ls(A.topLeftBorderStroke, A.topRightBorderStroke);
                  case 1:
                    return ls(
                  ...
                  default:
                    return ls(A.bottomLeftBorderStroke, A.topLeftBorderStroke);
                }
              })(l, U)),
              (e = os(l, U)),
              ...
              2 === C &&
                (Wn(e[0]) &&
                  ...
                  this.ctx.beginPath(),
                  this.formatPath([
                    new Nn(c.end.x, c.end.y),
                    new Nn(a.start.x, a.start.y),
                  ]),
                  this.ctx.stroke()),
                Wn(e[1]) &&
                  ((c = e[1]),
      ...
      (Is.prototype.render = function (r) {
        return a(this, void 0, void 0, function () {
          return H(this, function (A) {
            switch (A.label) {
              case 0:
  ...
  var ys,
    Ks = function (A) {
      return (
        A instanceof pr ||
        A instanceof dr ||
        (A instanceof ur && A.type !== Ur && A.type !== wr)
      );
    },
    ms = function (A, e) {
      switch (A) {
    ...
    bs = ["-apple-system", "system-ui"],
    Ds = function (A) {
      return /iPhone OS 15_(0|1)/.test(window.navigator.userAgent)
        ? A.filter(function (A) {
            return -1 === bs.indexOf(A);
          })
        : A;
    },
    vs =
  ...
  var Gs = ((Os.instanceCount = 1), Os);
  function Os(A, e) {
    (this.windowBounds = e),
      (this.instanceName = "#" + Os.instanceCount++),
      (this.logger = new Ss({ id: this.instanceName, enabled: A.logging })),
      (this.cache =
        null !== (e = A.cache) && void 0 !== e ? e : new vn(this, A));
  }
  "undefined" != typeof window && bn.setContext(window);
  var Vs = function (u, F) {
      return a(void 0, void 0, void 0, function () {
        var e, t, B, r, n, s, o, i, Q, c, a, g, w, U, l, C;
        return H(this, function (A) {
          switch (A.label) {
            case 0:
            ...
            case 1:
              ...
              (l = {
                ...
                width:
                  null !== (l = F.width) && void 0 !== l ? l : Math.ceil(r),
                height:
            ...
            case 3:
              return (
                ...
                i === C.styles.backgroundColor &&
                  (C.styles.backgroundColor = pe.TRANSPARENT),
                g.logger.debug(
    ...
    ks = function (A, e, t) {
      var B = e.ownerDocument,
        r = B.documentElement
          ? le(A, getComputedStyle(B.documentElement).backgroundColor)
          : pe.TRANSPARENT,
        n = B.body
          ? le(A, getComputedStyle(B.body).backgroundColor)
          : pe.TRANSPARENT,
        t =
          "string" == typeof t
            ? le(A, t)
